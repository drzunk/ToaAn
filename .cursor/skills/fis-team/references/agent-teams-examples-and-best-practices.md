...
For any template where teammates edit code (craft, fix), always use `isolation: "worktree"`:
...
| Craft (4 teammates) | ~400K-800K | Highest -- code generation |
