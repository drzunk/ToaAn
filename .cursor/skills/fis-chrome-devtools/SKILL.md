...
SKILL_DIR=""
if [ -d ".claude/skills/fis-chrome-devtools/scripts" ]; then
  SKILL_DIR=".claude/skills/fis-chrome-devtools/scripts"
elif [ -d "$HOME/.claude/skills/fis-chrome-devtools/scripts" ]; then
...
Skills can exist in **project-scope** or **user-scope**. Priority: project-scope > user-scope.
All in `.claude/skills/fis-chrome-devtools/scripts/`:
