...
**Brand:**
```bash
python3 .claude/skills/fis-design/scripts/logo/search.py "tech startup" --design-brief -p "BrandName"
```

**Tokens:**
Use the `fis-ui-styling` workflow to define and validate application tokens.
