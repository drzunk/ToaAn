...
Usage:
    cd ~/.claude/skills/fis-excalidraw/references
...
def render(
    ...
    try:
        ...
        print("Run: cd ~/.claude/skills/fis-excalidraw/references && uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run: cd ~/.claude/skills/fis-excalidraw/references && uv run playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
