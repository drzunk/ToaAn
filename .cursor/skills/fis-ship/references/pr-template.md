...
Use this template when creating a PR/MR via `gh pr create` (GitHub) or `glab mr create --description ...` (GitLab, incl. self-hosted).
...
- If the PR/MR already exists, update instead of create: `gh pr edit` (GitHub) or `glab mr update` (GitLab)
