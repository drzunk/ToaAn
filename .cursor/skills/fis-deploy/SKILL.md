...
For advanced infrastructure/troubleshooting, activate `/fis-devops` skill.
...
3. Run the deploy command from the selected `references/platforms/<platform>.md`
...
2. If unresolvable → activate `/fis-devops` skill
