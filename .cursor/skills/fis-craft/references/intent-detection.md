...
```
"/fis-craft implement user auth --interactive"
→ Mode: interactive (explicit flag, stops at review gates)

"/fis-craft implement user auth"
→ Mode: interactive (default, stops at review gates)

"/fis-craft plans/260120-auth/phase-02-api.md"
→ Mode: code (path detected, stops at review gates)

"/fis-craft quick fix for the login bug"
→ Mode: fast ("quick" keyword, stops at review gates)

"/fis-craft implement auth, payments, notifications, shipping"
→ Mode: parallel (4 features, stops at review gates)

"/fis-craft implement dashboard --fast"
...
"/fis-craft implement everything --auto"
