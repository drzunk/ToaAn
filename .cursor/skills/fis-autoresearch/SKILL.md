---
name: fis:autoresearch
description: "Run autonomous optimization loops (deprecated alias for fis-loop). Use for metric-driven iteration, coverage improvement, performance tuning."
category: utilities
...
# fis:autoresearch — Autonomous Optimization Loop
...
|-----------|-------------|
| Subjective goals ("make it cleaner") | `fis:craft` |
| Bug fixing with known root cause | `fis:fix` or `fis:debug` |
| One-shot tasks, no repetition needed | `fis:craft` |
| No mechanical metric to measure progress | `fis:craft --interactive` |
