...
1. **Screenshots provided** → Use `fis:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `fis:ai-multimodal` video-analysis for comprehensive context
