...
```bash
python .claude/skills/fis-copywriting/scripts/extract-writing-styles.py --list        # List files
python .claude/skills/fis-copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
