...
```bash
python3 .claude/skills/fis-threejs/scripts/search.py "<query>" [--domain <domain>] [-n <max_results>]
```
...
python3 .claude/skills/fis-threejs/scripts/search.py "particle compute webgpu"

# Search API for camera classes
python3 .claude/skills/fis-threejs/scripts/search.py "camera" --domain api

# Get examples for a use case
python3 .claude/skills/fis-threejs/scripts/search.py "product configurator" --use-case

# Filter by category
python3 .claude/skills/fis-threejs/scripts/search.py --category webgpu -n 10

# Filter by complexity
python3 .claude/skills/fis-threejs/scripts/search.py --complexity high -n 5
```
