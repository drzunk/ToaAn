...
python3 .claude/skills/fis-ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 .claude/skills/fis-ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 .claude/skills/fis-ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
...
### 3. Generate Assets
Use `fis:ai-multimodal` skill:
- Generate required visuals
- Verify quality quickly
- Use `fis:media-processing` for adjustments
