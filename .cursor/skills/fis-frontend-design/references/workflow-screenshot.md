...
## Prerequisites
- Activate `fis:ui-ux-pro-max` skill first for design intelligence
- Have `fis:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `fis:ai-multimodal` skill to extract:
...
- Remove backgrounds if needed with `fis:media-processing`
