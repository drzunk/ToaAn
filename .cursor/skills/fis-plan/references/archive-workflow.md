...
### Step 2: Summarize the plans and document them with `/fis-journal` skill invocation
...
- Stage and commit the changes (Use `/fis-git` for commit flow)
- Commit and push the changes (Use `/fis-git` for push flow)
