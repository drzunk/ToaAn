...
- Otherwise use `fis:repomix` to generate fresh codebase summary
- Use `/fis-scout` or `/fis-scout ext` to find relevant files
- Use `fis:docs-seeker` skill for package/plugin documentation
