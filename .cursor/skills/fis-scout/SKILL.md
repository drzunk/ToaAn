...
**Typically precedes:** `/fis-debug` (debug after scouting), `/fis-fix` (fix after locating code), `/fis-code-review` (scout edge cases before review)
**Related:** `/fis-debug` (investigate after scouting), `/fis-brainstorm` (explore after scouting)
