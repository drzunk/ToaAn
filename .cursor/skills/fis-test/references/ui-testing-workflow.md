...
Activate the fis:chrome-devtools skill.
...
```bash
cd $SKILL_DIR  # .claude/skills/fis-chrome-devtools/scripts
...
## Workflow
- Use `fis:plan` skill to organize the test plan & report
...
- Use `fis:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/fis-preview`
