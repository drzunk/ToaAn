...
Review tasks are **separate from** craft/planning phase tasks.

**When craft spawns review:**
1. Craft completes implementation phase → creates review pipeline tasks
2. Review pipeline executes (scout → review → adversarial → fix → verify)
3. All review tasks complete → craft marks phase as reviewed
