...
When generating mermaid code blocks, use `/fis-mermaidjs-v11` skill for v11 syntax rules.
...
For `--slides`: recommend invoking `/fis-ui-ux-pro-max` for richer style selection.
Must use `/fis-mermaidjs-v11` for any Mermaid diagrams.
