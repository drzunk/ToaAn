...
2. If no logo provided: generate with `fis:ai-multimodal` skill
3. Screenshot wireframes with `fis:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **fis:plan** skill: `/fis-plan --fast <requirements>`
