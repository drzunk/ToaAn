...
3. If no logo provided: generate with `fis:ai-multimodal` skill
4. Screenshot wireframes with `fis:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **fis:plan** skill: `/fis-plan --auto <requirements>`
...
Activate **fis:craft** skill: `/fis-craft --auto <plan-path>`
