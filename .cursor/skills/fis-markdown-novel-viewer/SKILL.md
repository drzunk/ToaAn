---
name: fis:markdown-novel-viewer
...
**Note:** HTML generation mode (`/fis-preview --html ...`) produces self-contained HTML files that open directly in the browser — they do not use this server.

## ⚠️ Installation Required

**This skill requires npm dependencies.** Install manually:

```bash
cd .claude/skills/fis-markdown-novel-viewer
npm install
```
...
node .claude/skills/fis-markdown-novel-viewer/scripts/server.cjs \
...
node .claude/skills/fis-markdown-novel-viewer/scripts/server.cjs --stop
```

## Skill Invocation

Use `/fis-preview` for quick access:

```bash
/fis-preview plans/my-plan/plan.md    # View markdown file
/fis-preview plans/                   # Browse directory
/fis-preview --stop                   # Stop server
```
...
node .claude/skills/fis-markdown-novel-viewer/scripts/server.cjs --file ./README.md --host 0.0.0.0 --port 3456
```
