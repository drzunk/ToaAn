...
public class TaiLieuPage {
    ...
    public void waitStepReady() {
        webUI.waitUntilVisible(stepReadyMarker, 15, "Bước 5 [Tài liệu & chứng cứ]");
    }
    ...
    public void uploadTaiLieuBatBuoc() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            System.out.println(" ➔ Tải lên: 'sample.pdf' tại [Tài liệu bắt buộc: " + tenTaiLieu + "]");
            webUI.sleep(1);
        }
    }
    ...
    public void uploadTaiLieuBoSung(String coTaiLieuBoSung) {
        ...
        if (!webUI.isElementVisible(optionalFileInput)) {
            System.out.println(" ⏩ Bỏ qua [Tài liệu bổ sung] — form ẩn.");
            return;
        }
